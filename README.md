...
Installation & SetupPrerequisitesMATLAB R2021a or laterDeep Learning ToolboxAudio ToolboxSimulink (for real-time deployment simulation)1. Clone the RepositoryBashgit clone https://github.com/YourUsername/GalamseyGuard.git
cd GalamseyGuard
